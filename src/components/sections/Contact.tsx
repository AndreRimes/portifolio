...
export default function Contact() {
    ...
    return (
        <div id="contact" className="w-full h-full flex flex-col items-center justify-center gap-4">
            ...
            <Revel>
                <p className="text-lg md:w-[90%] md:text-center md:text-2xl font-extralight">
            ...
            <Revel>
                <div
                    ...
                    <Link target="_blank" className={`text-xl md:text-2xl font-semibold ${hover ? "text-primary" : ""} `} href={"mailto:andre.2004.rimes@gmail.com"}>
